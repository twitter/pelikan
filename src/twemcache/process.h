...
#define CMD_PROCESS_METRIC(ACTION)                                         \
    ...
    ACTION( cmd_append_stored,     METRIC_COUNTER, "# append successes"   )\
    ACTION( cmd_append_notfound,   METRIC_COUNTER, "# append not_founds"  )\
    ACTION( cmd_append_ex,         METRIC_COUNTER, "# append errors"      )\
    ACTION( cmd_prepend_stored,    METRIC_COUNTER, "# prepend successes"  )\
    ACTION( cmd_prepend_notfound,  METRIC_COUNTER, "# prepend not_founds" )\
    ACTION( cmd_prepend_ex,        METRIC_COUNTER, "# prepend errors"     )
