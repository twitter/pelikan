...
fn bucket_index() {
    ...
    assert_eq!(ttl_buckets.get_bucket_index(CoarseDuration::from_secs(1)), 0);
    assert_eq!(ttl_buckets.get_bucket_index(CoarseDuration::from_secs(7)), 0);
    ...
    for bucket in 1..256 {
        ...
        assert_eq!(ttl_buckets.get_bucket_index(start) as u32, bucket, "ttl: {:?}", start);
        assert_eq!(ttl_buckets.get_bucket_index(end) as u32, bucket, "ttl: {:?}", end);
    }
    ...
    for bucket in 16..256 {
        ...
        assert_eq!(ttl_buckets.get_bucket_index(start) as u32, bucket + 256, "ttl: {:?}", start);
        assert_eq!(ttl_buckets.get_bucket_index(end) as u32, bucket + 256, "ttl: {:?}", end);
    }
    ...
    for bucket in 16..256 {
        ...
        assert_eq!(ttl_buckets.get_bucket_index(start) as u32, bucket + 512, "ttl: {:?}", start);
        assert_eq!(ttl_buckets.get_bucket_index(end) as u32, bucket + 512, "ttl: {:?}", end);
    }
    ...
    for bucket in 16..256 {
        ...
        assert_eq!(ttl_buckets.get_bucket_index(start) as u32, bucket + 768, "ttl: {:?}", start);
        assert_eq!(ttl_buckets.get_bucket_index(end) as u32, bucket + 768, "ttl: {:?}", end);
    }

    // TTLs longer than 97 days are the max TTL
    assert_eq!(ttl_buckets.get_bucket_index(CoarseDuration::from_secs(8_388_608)) as u32, 1023);
}
