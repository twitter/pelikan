function(cargo_build)
    ...
    if(RUST_CDYLIB_BUILD)
        set(LIB_FNAME "${CMAKE_STATIC_LIBRARY_PREFIX}${LIB_NAME}${CMAKE_STATIC_LIBRARY_SUFFIX}")
    else()
        set(LIB_FNAME "${CMAKE_DYNAMIC_LIBRARY_PREFIX}${LIB_NAME}${CMAKE_DYNAMIC_LIBRARY_SUFFIX}")
    endif()

    set(LIB_FILE "${CARGO_TARGET_DIR}/${LIB_TARGET}/${LIB_BUILD_TYPE}/${LIB_FNAME}")
